...
if __name__ == "__main__":
    ...
    # 3、taiji自己部署模型 这里是免费的，
    model_name="gpt-oss-120b-yd" 
    # model_name="A32B_15.6T256k_turbos_hunyuan2.0_sft_exp_1029_bus_step3192"
    # model_name="deepseek_v3.1_rl_infer_gy"
    # model_name="ds_v3_1_w4a8_bj_yq"
    # model_name="maguai_mix_inf_3.1_BJ_v1"
    # model_name="maguai_mix_inf_3.1_BJ_v1_128k"
    # model_name="deepseek_v3.1_rl_infer_gy"
    # model_name="roleplay_exp4_tips_9k_hf"
    # model_name="gpt-oss-120b-tc"
    # model_name="gpt-oss-120b-qa"


    # model_name="DeepSeek-V3.2-A37B-eason"
    # model_name="DeepSeek-V3.2-A37B-bio"
    # model_name="DeepSeek-V3.2-QA"
    
    # model_name="DeepSeek-V3-0324-Crawl"
    ...
    # eval_data_path = '/apdcephfs_qy4/share_302593112/rolandwu/project/hunyuan_luodi/LLM-RolePlay-R1/train_data/快慢思考数据班车/20251029-本地实验-快思考/角色扮演/标签体系构建-20251227/query_data/get_roleplay_sp_attribute_20251227.jsonl'
    # eval_data_path = '/apdcephfs_qy4/share_302593112/rolandwu/project/hunyuan_luodi/LLM-RolePlay-R1/train_data/快慢思考数据班车/20260120-快思考角色扮演-hy3.0/20260205-角色类别优化/query_data/get_is_slut_20260206.jsonl'

    # eval_data_path = '/apdcephfs_qy4/share_302593112/rolandwu/project/hunyuan_luodi/LLM-RolePlay-R1/train_data/快慢思考数据班车/20260120-快思考角色扮演-hy3.0/20260205-角色类别优化/query_data/get_role_setting_20260208.jsonl'

    # eval_data_path = '/apdcephfs_qy4/share_302593112/rolandwu/project/hunyuan_luodi/LLM-RolePlay-R1/train_data/_tool_script/agentic_chat/query_data/get_exp29_sp_merge.json'

    # eval_data_path = '/apdcephfs_qy4/share_302593112/rolandwu/project/hunyuan_luodi/LLM-RolePlay-R1/eval_data/角色评测/20260228-质检prompt/query_data/get_data_quality_check.jsonl'
    # eval_data_path = '/apdcephfs_qy4/share_302593112/rolandwu/project/hunyuan_luodi/LLM-RolePlay-R1/eval_data/角色评测/20260228-质检prompt/query_data/get_data_quality_check—exp2-5.jsonl'
    ...
    # eval_data_path = '/apdcephfs_qy4/share_302593112/rolandwu/project/hunyuan_luodi/LLM-RolePlay-R1/eval_data/角色评测/20260228-质检prompt/query_data/get_data_quality_check—20260307.jsonl'

    # eval_data_path = '/apdcephfs_qy4/share_302593112/rolandwu/project/hunyuan_luodi/LLM-RolePlay-R1/eval_data/角色评测/20260228-质检prompt/query_data/get_data_quality_check-ds3.2—20260307.jsonl'
